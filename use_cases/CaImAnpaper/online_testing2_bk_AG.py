...
params_movie = [{}]*13        # set up list of dictionaries
...
#% yuste
params_movie[11] = {'fname': '/mnt/home/agiovann/SOFTWARE/CaImAn/example_movies/demoMovieJ.tif',
                 'folder_name': '/mnt/home/agiovann/SOFTWARE/CaImAn/example_movies/',
                 'epochs' : 2,
                 'ds_factor' : 1,
                 'p': 1,  # order of the autoregressive system
                 'fr' : 10,
...
#% zebra
params_movie[12] = {'fname': '/mnt/ceph/neuro/zebra/05292014Fish1-4/images/mmap_tifs/Plane17_100_500_400_-350_mc.tif',
                 'folder_name': '/mnt/ceph/neuro/zebra/05292014Fish1-4/images/mmap_tifs/',
                 'epochs' : 1,
                 'ds_factor' : 1,
                 'p': 1,  # order of the autoregressive system
                 'fr' : 5,
...
N_samples = np.ceil(params_movie[ind_dataset]['fr']*params_movie[ind_dataset]['decay_time'])   # number of timesteps to consider when to_julia new neuron candidates
...
save_results = False
if save_results:
    np.savez(params_movie[ind_dataset]['folder_name']+'results_analysis_online_sensitive.npz',
...
if ploton:
    ...
    min_SNR = 2.5
    N_samples = np.ceil(params_movie[ind_dataset]['fr']*params_movie[ind_dataset]['decay_time']).astype(np.int)   # number of timesteps to consider when to_julia new neuron candidates
